...
def START():
    ...
    root = Tk()
    heading=Label(root,text="BHARAT HOSPITALS",padx=300,pady=50,width=30,font=(None,30)).grid(row=1,column=2)
    ...
    def printSomething():
        ...
        sender_email = "rakeshnimmala26@gmail.com"
        rec_email = email.get()
        password = "xorfecvamocqsdsi"
        subject="Medical Prescription"
        message = "BHARAT HOSPITALS \n \n Medical prescription \n \n"+"Patient Name ="+pname+"\n"+"Age ="+page+"\n"+"Gender=" +pgender+"\n"+"medicine="+mname+"\n"+"Medicine Time="+mtime
